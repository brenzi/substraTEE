...
typedef struct ms_create_sealeddata_t {
	sgx_status_t ms_retval;
	uint8_t* ms_sealed_log;
	uint32_t ms_sealed_log_size;
} ms_create_sealeddata_t;

typedef struct ms_verify_sealeddata_t {
	sgx_status_t ms_retval;
	uint8_t* ms_sealed_log;
	uint32_t ms_sealed_log_size;
} ms_verify_sealeddata_t;
...
sgx_status_t create_sealeddata(sgx_enclave_id_t eid, sgx_status_t* retval, uint8_t* sealed_log, uint32_t sealed_log_size)
{
	sgx_status_t status;
	ms_create_sealeddata_t ms;
...
sgx_status_t verify_sealeddata(sgx_enclave_id_t eid, sgx_status_t* retval, uint8_t* sealed_log, uint32_t sealed_log_size)
{
	sgx_status_t status;
	ms_verify_sealeddata_t ms;
	ms.ms_sealed_log = sealed_log;
	ms.ms_sealed_log_size = sealed_log_size;
